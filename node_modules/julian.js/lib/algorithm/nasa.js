...
module.exports = function NASA(date) {
  ...
  if (year >= 500 && year < 1600) {
    u = (y - 1000) / 100;
    t = 1574.2 - 556.01 * u + 71.23472 * u * u + 0.319781 * u * u * u - 0.8503463 * u * u * u * u - 0.005050998 * u * u * u * u * u + 0.0083572073 * u * u * u * u * u * u;
  }
  ...
  if (year >= 1700 && year < 1800) {
    u = y - 1700;
    t = 8.83 + 0.1603 * u - 0.0059285 * u * u + 0.00013336 * u * u * u - u * u * u * u / 1174000;
  }

  if (year >= 1800 && year < 1860) {
    u = y - 1800;
    t = 13.72 - 0.332447 * u + 0.0068612 * u * u + 0.0041116 * u * u * u - 0.00037436 * u * u * u * u + 0.0000121272 * u * u * u * u * u - 0.0000001699 * u * u * u * u * u * u + 0.000000000875 * u * u * u * u * u * u * u;
  }

  if (year >= 1860 && year < 1900) {
    u = y - 1860;
    t = 7.62 + 0.5737 * u - 0.251754 * u * u + 0.01680668 * u * u * u - 0.0004473624 * u * u * u * u + u * u * u * u * u / 233174;
  }

  if (year >= 1900 && year < 1920) {
    u = y - 1900;
    t = -2.79 + 1.494119 * u - 0.0598939 * u * u + 0.0061966 * u * u * u - 0.000197 * u * u * u * u;
  }
  ...
  if (year >= 1986 && year < 2005) {
    u = y - 2000;
    t = 63.86 + 0.3345 * u - 0.060374 * u * u + 0.0017275 * u * u * u + 0.000651814 * u * u * u * u + 0.00002373599 * u * u * u * u * u;
  }
